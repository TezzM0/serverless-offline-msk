...
var ServerlessOfflineAwsMskPlugin = /** @class */ (function () {
    function ServerlessOfflineAwsMskPlugin(serverless, options) {
        ...
        (_c = (_e = this.serverlessOfflineOptions).lambdaPort) !== null && _c !== void 0 ? _c : (_e.lambdaPort = (_d = this.options.lambdaPort) !== null && _d !== void 0 ? _d : 3002);
        this.customOptions = custom['serverless-offline-msk'] || {};
        (_f = this.customOptions).allowAutoTopicCreation || (_f.allowAutoTopicCreation = true);
        (_g = this.customOptions).clientId || (_g.clientId = defaultKafkaClientId);
        (_h = this.customOptions).brokers || (_h.brokers = []);
    ...
    ServerlessOfflineAwsMskPlugin.prototype.connectAndListen = function (fn, event) {
        return __awaiter(this, void 0, void 0, function () {
            var lambdaParams, lambda, groupId, consumer;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        lambdaParams = {
                            endpoint: "http://localhost:".concat(this.serverlessOfflineOptions.lambdaPort),
                            region: 'us-east-1',
                            credentials: {
                                accessKeyId: 'root',
                        ...
                        groupId = fn.name || "serverless-offline-msk";
